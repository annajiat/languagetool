...
public class ArabicNumbersWordsTest {
 ...
 private void validateNumbersMap(Map<String, String> numbersMap, boolean feminin) {
  ...
  private void validateNumbersMap(Map<String, String> numbersMap, boolean feminin, boolean isAttached, String inflectCase) {
    for (Map.Entry<String, String> entry : numbersMap.entrySet()) {
      String words = ArabicNumbersWords.numberToArabicWords(entry.getKey(), feminin, isAttached, inflectCase);
